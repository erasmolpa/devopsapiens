...
Cuando nos toca arrancar un proyecto en Operaciones/It ,en el que se pretende usar soluciones basadas en IaC  (Infrastructure as Code), es común llevar la conversación al contexto de la solución. Por inersia nos posturamos hacia una solución por experiencias previas, comodidad o afinidad hacia una herramienta/lenguaje. 

Esto es totalmente lógico. Nos gusta sentirnos cómodos y seguros en el día a día y no hay nada malo en ello. Pero la realidad es que , llevar a buen puerto la IaC es algo bastante complejo , y hay infinidad de cosas a tener en cuenta , asi que , seamos de mente abierta y asumamos que igual en algún punto o paso del proceso , nos tocará seguir usando ese script bash que tanto odias. Sand but true. 

Este post, vamos a mencinar algunos principios y características que creo que pueden ser útiles en este tipo de toma de decisiones.

# El Problema:

Independientemente de tu rol o experiencia en el mundo de la tecnología, es bastante probable que en algún momento de tu carrera, y con más frecuencia de la que te gustaría, hayas tenido que lidiar con la frustrante labor de aprovisionar o configurar infraestructura.
...
Todo esto cuesta mucho dinero a las compañías.También cuesta dinero tener infraestructura creada sin ser usada , sólo porque alguien la pedirá en algún momento y es más cara borrarla y volver a crearla, que mantenerla viva. (sad but true)
...
Creo que hay un cosenso comun........; lo de crear infraestructura con la UI del proveedor de cloud de turno, o usando un script que tienes en tu máquina, esta bien para una POC,un entorno de pruebas...pero para poco más.tiene cierto valor en ese momento/contexto.
...
## Fundamentos básicos
 En general te diria que seas todo lo pragmatico que puedas, y que , para cada aspecto te dejes asesorar los compañeros que puedan ayudarte a tomar buenas decisiones. Es decir, si 
