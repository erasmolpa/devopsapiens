...
Aunque puedas decir eso de... "en mi local funciona!", seguramente no estás exento de alguna que otra batalla contra la máquina.
...
Este tipo de situaciones, y otras muchas, hacen que todo este proceso de "llegar a un acuerdo" se convierta en costoso.

Existen infinidad de evidencias de este dolor. Una en la que me suelo fijar mucho, es cuando se mantienen entornos vivos, sin ser utilizados, por el mero hecho de que , eliminarlos y volverlos a recrear es muy constoso o incluso imposible. 

Todo esto cuesta muchísimo dinero a las empresas y por suerte el 
...
Todo esto afecta directamente al dinamismo de la propia compañía y a cómo plantean sus estrategias técnicas. Por lo tanto, la IaC se convierte en un factor clave a considerar.
